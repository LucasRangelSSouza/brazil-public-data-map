...
The release gate excludes natural-person and unknown supplier documents. It derives an organization linkage key only for an eligible CNPJ record. Public source availability does not settle redistribution terms; each source requires a release-time review.
